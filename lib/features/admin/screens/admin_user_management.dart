    ...
    showDialog(
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: Text(
              'Bạn có chắc muốn xóa tài khoản của "$name"?\nHành động này không thể hoàn tác.',
            ),
            actions: [
              TextButton(
                                ...
                                try {
                                  ...
                                  if (ctx.mounted) {
                                    ScaffoldMessenger.of(ctx).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          '✅ Đã gửi email đặt lại MK tới $userEmail',
                                        ),
                          ...
                          saving
                              ...
                              : () async {
                                ...
                                try {
                                  ...
                                  await FirestoreService.updateUserByAdmin(
                                    uid,
                                    {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        backgroundColor:
                            isAdmin
                                ? const Color(0xFFf7971e).withValues(alpha: 0.2)
