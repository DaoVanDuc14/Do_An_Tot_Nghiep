          ...
          children: [
            ...
            if (widget.isAutoSubmit) ...[
              ...
              Container(
                ...
                child: const Text(
                  '⏰ Bài thi đã tự động nộp vì hết thời gian',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.orange,
                    fontSize: 12,
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _stat(
                    '❌ Sai',
                    '${total - widget.correctCount}/$total',
                    AppColors.error,
                  ),
                ),
                const SizedBox(width: 10),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (isPron && isAnswered)
                            Text(
                              '🎙 Accuracy: ${ans['accuracy']}% — ${isCorrect ? '✅ ĐẠT' : '❌ CHƯA ĐẠT'}',
                              style: TextStyle(
                                fontSize: 12,
                                color:
                                    isCorrect
