          ...
          builder: (context, pSnap) {
            ...
            return Column(
              ...
              children: [
                ...
                Text(
                  '${avg.toStringAsFixed(0)}% hoàn thành',
    ...
    showDialog(
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: const Text(
              'Toàn bộ câu hỏi bên trong cũng sẽ bị xóa vĩnh viễn.',
            ),
            actions: [
              TextButton(
  ...
  Widget _buildTopicCard(
    ...
    final gradientList = [
      ...
      [
        ...
        const Color(0xFF0077B6).withValues(alpha: 0.08),
      ],
      [
        const Color(0xFF8E54E9).withValues(alpha: 0.12),
        const Color(0xFF4776E6).withValues(alpha: 0.08),
      ],
      [
    ...
    return Container(
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(
                        iconList[colorIndex],
                        color: iconColorList[colorIndex],
                        size: 28,
                      ),
                    ),
                    ...
                    if (isOwner)
                      PopupMenuButton<String>(
                        onSelected: (v) {
                          if (v == 'edit') {
                            _showTopicDialog(context, topic: t);
                          } else if (v == 'delete') {
                            _confirmDeleteTopic(context, t);
                          }
                        },
                        itemBuilder:
                            (_) => const [
        ...
        .slideX(begin: 0.03, end: 0, duration: 350.ms, delay: (50 * index).ms);
  }
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  isExplore
                      ? 'Chưa có chủ đề cộng đồng nào.'
                      : 'Bạn chưa tạo chủ đề nào.',
                  style: const TextStyle(
                    color: AppColors.textSecondary,
                    fontSize: 15,
                  ),
          ...
          children: [
                      ...
                      child: InkWell(
                        onTap:
                            () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const UserExamManagement(),
                              ),
                            ),
                        borderRadius: BorderRadius.circular(16),
                        child: Container(
            ...
            if (isLoading)
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Admin chưa tạo đề thi nào hoặc chưa xuất bản.',
                        style: TextStyle(
                          color: AppColors.textLight,
                          fontSize: 13,
                        ),
              ...
              ...papers.asMap().entries.map(
                (e) => _buildPaperCard(context, e.value, e.key),
              ),
            ],
          ],
        );
    ...
    return StatefulBuilder(
      builder:
          (context, setS) => Container(
                            ...
                            onPressed:
                                loading
                                    ...
                                    : () async {
                                      ...
                                      try {
                                        final snap =
                                            await FirestoreService.examQuestionsStream(
                                              paper.id,
                                            ).first;
                                        final questions =
                                            FirestoreService.parseExamQuestions(
                                              snap,
                                            );
              ...
              .animate()
              .fadeIn(duration: 400.ms, delay: (300 + 80 * index).ms)
              .slideY(
                begin: 0.03,
                end: 0,
                duration: 400.ms,
                delay: (300 + 80 * index).ms,
              ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          _buildTopicList(
            FirestoreService.myTopicsStream(uid ?? ''),
            isExplore: false,
          ),
          _buildTopicList(
