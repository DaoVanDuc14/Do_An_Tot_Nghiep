...
class TopicDetailScreen extends StatelessWidget {
    ...
    showDialog(
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            title: Text(
              isEdit ? 'Sửa Câu Nói' : 'Thêm Câu Nói',
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return StreamBuilder<DocumentSnapshot>(
                      stream: FirestoreService.progressStream(
                        user?.uid ?? '',
                        s.id,
                      ),
  ...
  Widget _scoreCircle(int score, Color color) => SizedBox(
    width: 48,
    height: 48,
    child: Stack(
      fit: StackFit.expand,
