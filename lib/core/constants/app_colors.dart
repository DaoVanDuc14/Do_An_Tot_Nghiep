...
class AppColors {
  ...
  static const List<Color> headerGradient = [Color(0xFF0D47A1), Color(0xFF1E88E5)];
  static const List<Color> cardGradient = [Color(0xFF1565C0), Color(0xFF42A5F5)];
  static const List<Color> successGradient = [Color(0xFF1B5E20), Color(0xFF4CAF50)];
  static const List<Color> errorGradient = [Color(0xFFB71C1C), Color(0xFFEF5350)];
  static const List<Color> purpleGradient = [Color(0xFF4776E6), Color(0xFF8E54E9)];
  static const List<Color> warmGradient = [Color(0xFFF57C00), Color(0xFFFFB74D)];
}
